...
$(function(){
    ...
    $('.tabs-head li').click(function(){
        ...
        if(!$(this).hasClass('active')){ 
          ...
          $('.tabs-body .tab-b').removeClass('active');

          $($('.tabs-head li.active').data("tab")).addClass('active');
          return false;
       }
       return false;
      });

      $('.arr.trigger').on('click', function(event) {
      ...
      $('.dropdown-menu label').on('click', function() {
          $(this).parent('.dropdown-menu').slideUp();
          let content = $(this).children('input').val();
          $(this).parent('.dropdown-menu').siblings('.arr').text(content).removeClass('open');
      })
